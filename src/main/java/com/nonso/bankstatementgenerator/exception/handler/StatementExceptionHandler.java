...
import com.nonso.bankstatementgenerator.exception.UnAuthorizedException;
...
import static com.nonso.bankstatementgenerator.utils.ErrorCode.CONSTRAINT_VIOLATION;
...
public class StatementExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({StatementException.class, UnAuthorizedException.class})
    public ResponseEntity<Object> handleCustomException(StatementException e) {
